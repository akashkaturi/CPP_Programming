...
#include<bits/stdc++.h>
using namespace std;
class student{ // by default c++ data members or attributes are private members which can be used only inside of the class.
    string name;
    public:
    ...
    ~student(){  //destructor - used to destroy the objects created
